  ...
  const handleDemoLogin = async () => {
    ...
    try {
      ...
      try {
        ...
        console.log("Erreur Supabase ignorée pour la démo:", supabaseError);
      }
      
      // Solution de contournement pour la démo : contourner Supabase et rediriger directement
      console.log("Utilisation du mode démo sans authentification Supabase");
      
      // Simulation d'une authentification réussie
      localStorage.setItem('trendmancer-demo-user', JSON.stringify({
        id: 'demo-user-id',
        email: 'demo@trendmancer.com',
      ...
      setError(error.message || 'Une erreur est survenue lors de la connexion démo.');
    } finally {
      setLoading(false);
    }
  };
